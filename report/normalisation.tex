...
\\COURSEWORKMARKS(\underline{student id}, \underline{coursework id}, \underline{module id}, mark)\\
...
BUILDINGS(\underline{building}, faculty)\\
...
STUDENTMODULES(\underline{student id}, \underline{module id}, exam mark)\\
LECTURERMODULES(\underline{lecturer email}, \underline{module id})\\
COURSEWORKMARKS(\underline{student id}, \underline{module id}, \underline{coursework id}, mark)\\
